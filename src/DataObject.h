...
class DataObject {
  private:
    ...
    const std::vector<std::string> dangerzone_ranks = {
        "Hidden",           "Lab Rat I",         "Lab Rat II",
        "Sprinting Hare I", "Sprinting Hare II", "Wild Scout I",
        "Wild Scout II",    "Wild Scout Elite",  "Hunter Fox I",
        "Hunter Fox II",    "Hunter Fox II",     "Hunter Fox Elite",
        "Timber Wolf",      "Ember Wolf",        "Wildfire Wolf",
        "The Howling Alpha"};
    ...
    const std::string steam_profile_url_base =
